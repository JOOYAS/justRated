...
const About = () => {
    return (
        <div className="relative min-h-dvh flex justify-center-safe w-screen px-[1rem] md:px-12 md:py-12 md:ps-0 bg-gradient-to-br from-indigo-800 to-pink-600 overflow-hidden">
            <div className="relative flex flex-col justify-center items-center p-6 md:w-[65%] bg-emerald-50 dark:bg-indigo-950 md:rounded-e-4xl  md:shadow-2xl">
                <div>
                    <header className="mb-8  text-center md:text-start">
                        <h1 className="text-7xl font-extrabold tracking-tight mb-2">About Us</h1>
                ...
                <img className="absolute h-16 bottom-0 mb-4 mx-auto" src="/images/just_rated_logo_new3.svg" alt="logo" />
            </div>
            ...
            <div className="relative hidden md:flex flex-1 flex-col justify-center items-center">
                ...
                <img className='px-10 h-36 text-amber-50 z-10' src='/images/just_rated_logo_new3.svg' />
            </div>
        </div>
    )
}
