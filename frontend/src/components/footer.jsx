...
const Footer = () => {
    return (
        <footer className="mt-8 bg-gradient-to-t from-neutral-900 via-neutral-800 to-neutral-700 text-neutral-200 bottom-0">
            <div className="max-w-7xl mx-auto px-6 py-8 flex flex-col sm:flex-row-reverse items-center justify-between gap-6">
                <div className="flex items-center gap-3">
                    <img className="h-12" src="/images/just_rated_logo_new3.svg" alt="logo" />
                </div>
