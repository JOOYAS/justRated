...
const Footer = () => {
    return (
        <footer className="bg-gradient-to-t from-neutral-900 via-neutral-800 to-neutral-700 text-neutral-200 bottom-0">
            ...
            <div className="border-t border-neutral-700 text-center py-4 text-xs text-neutral-400">
